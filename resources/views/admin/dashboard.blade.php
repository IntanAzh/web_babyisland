            ...
            <main class="flex-1 p-14 overflow-y-auto bg-orange-50">
                ...
                <div class="grid grid-cols-4 gap-6 mb-8">
                    <div class="bg-white rounded-lg p-4 shadow text-center">
                        ...
                        <h2 class="text-xl font-bold text-gray-800 mt-2">1129 Users</h2>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-4 shadow text-center">
                        ...
                        <h2 class="text-xl font-bold text-gray-800 mt-2">573 Orders</h2>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-4 shadow text-center">
                        ...
                        <h2 class="text-xl font-bold text-gray-800 mt-2">32 Products</h2>
                    </div>
