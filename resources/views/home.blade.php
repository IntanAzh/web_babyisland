    ...
    <body class="bg-gray-100 ">
        ...
        <header class="bg-white py-10 text-center bg-center bg-cover h-[608px] relative z-10 mt-10"
            ...
            <div class="hero-text md:w-[50%] w-[90%] absolute right-9 top-3">
                ...
                <h1 class="text-[#F9BD64] text-center text-lg md:text-xl lg:text-3xl font-bold">Baby Island <br>
        ...
        <section class="bg-[#FEF2E0] pt-8">
            ...
            <div class="max-w-4xl h-[350px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-5 mt-5 p-5">
                ...
                <div class="p-5shadow-lg rounded flex flex-col items-center mt-18">
                    <div
                        class="gambar bg-[#FBD7A2] p-4 rounded-full w-[150px] h-[150px] flex justify-center items-center ">
